...
import PlayerModal from '@/features/players-modal/PlayerModal';
...
const DataView: React.FC<DataViewProps> = (props) => {
    ...
    // @TODO: compile highlighted players from userStarters/oppStarters
    ...
    return (
            <section className='px-4 pt-3 grid grid-cols-2 gap-3 text-primary-text lg:px-6 lg:pt-6'>
                ...
                <div className="grid grid-cols-2 col-span-2 gap-3">
                    {/* @TODO: move context here and create Timeslots component */}
